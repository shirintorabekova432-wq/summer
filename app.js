...
// Firebase yordam funksiyasi — firebase-config.js da db va auth aniqlanadi
function getUserDocRef() {
  if (typeof auth === "undefined" || !auth || !auth.currentUser) return null;
  return db.collection("users").doc(auth.currentUser.uid).collection("data").doc("reading_state");
}
